...
<section class="contact-page-section">
    <div class="contact-page-grid">
        ...
        <div class="contact-info-side">
            ...
            <div class="contact-social">
                ...
                <div class="social-icons">
                    <a href="https://www.facebook.com/weaboremn" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
        ...
        <!-- Google Map with Business Listing -->
...
<section class="section contact-form-section">
    <div class="container">
        <div class="contact-form-wrapper centered">
...
.contact-form-wrapper.centered h2 {
    color: var(--primary-green);
    margin-bottom: 10px;
}

.contact-form-wrapper.centered > p {
    color: var(--text-light);
    margin-bottom: 30px;
}

.contact-form-wrapper.centered .contact-form {
    text-align: left;
}
