...
<main id="main" class="site-main">
    ...
    <section class="page-hero" style="background: linear-gradient(135deg, var(--primary-green) 0%, var(--primary-green-dark) 100%);">
        <div class="container">
            ...
            <a href="<?php echo esc_url(home_url('/submit-article')); ?>" class="btn btn-outline-white hero-btn">
        ...
        <div class="container">
            ...
            <div class="no-posts">
                <div class="no-posts-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line></svg>
                </div>
                <h3>No Articles Yet</h3>
                <p>We're working on bringing you helpful content about mental health, wellness, and community programs. Check back soon!</p>
    ...
    <!-- CTA Section -->
    <section class="blog-cta section-padding">
        <div class="container text-center">
            <h2>Questions About Our Services?</h2>
            <p>Contact us to learn more about mental health and personal care services in your community.</p>
            <div class="cta-buttons">
                <a href="<?php echo esc_url(home_url('/contact')); ?>" class="btn btn-white">Contact Us</a>
                <a href="<?php echo esc_url(home_url('/services')); ?>" class="btn btn-outline-white">Our Services</a>
            </div>
        </div>
    </section>
</main>
