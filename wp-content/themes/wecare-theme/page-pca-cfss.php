    ...
    <div class="container">
        ...
        <div class="service-grid">
            ...
            <div class="service-image">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/Website Photos/CFSS - Home, Our Services & Referrals Page.webp" alt="WeCare CFSS Community First Services and Supports in Central Minnesota" />
            </div>
        </div>
    </div>
</section>
